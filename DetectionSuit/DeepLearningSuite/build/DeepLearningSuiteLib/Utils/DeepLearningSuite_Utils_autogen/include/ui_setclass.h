...
public:
    ...
    {
        SetClass->setWindowTitle(QApplication::translate("SetClass", "SetClass", 0));
        label->setText(QApplication::translate("SetClass", "will be converted to ", 0));
        pushButton_ok->setText(QApplication::translate("SetClass", "OK", 0));
        pushButton_cancel->setText(QApplication::translate("SetClass", "CANCEL", 0));
    } // retranslateUi
