...
public:
    ...
    void retranslateUi(QMainWindow *appconfig)
    {
        ...
        checkBox->setText(QApplication::translate("appconfig", "Select Indivudually", 0));
        label_6->setText(QApplication::translate("appconfig", "weightsPath", 0));
        label_7->setText(QApplication::translate("appconfig", "evaluationsPath", 0));
        label_8->setText(QApplication::translate("appconfig", "namesPath", 0));
        label_9->setText(QApplication::translate("appconfig", "netCfgPath", 0));
        toolButton_weights->setText(QApplication::translate("appconfig", "...", 0));
        toolButton_eval->setText(QApplication::translate("appconfig", "...", 0));
        toolButton_names->setText(QApplication::translate("appconfig", "...", 0));
        toolButton_cfg->setText(QApplication::translate("appconfig", "...", 0));
        label_10->setText(QApplication::translate("appconfig", "Config file", 0));
        toolButton_appconfig->setText(QApplication::translate("appconfig", "...", 0));
    } // retranslateUi
